...
#' @return Second-Order Rotatable Designs with coded levels
#'
#' @examples
#'
...
#'@export
SORD_coded<-function(v,n0,randomization=FALSE,variance=FALSE){
...
if(randomization==F){
#print("SORD (Standard)",quote=FALSE)
  message("SORD (Standard)")
print(final)
}else{
  ...
  rownames(mat3)<-NULL
  #print("SORD (Randomized)",quote=FALSE)
  message("SORD (Randomized)")
  print(mat3)
  final<-mat3
